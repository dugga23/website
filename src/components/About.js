    ...
    <>
      ...
      <div class="container mx-auto flex flex-col items-center justify-center">
        <div class="p-4 text-center">
          ...
          <img
            src="./pexels-yan-krukau-8837438 (1).jpg"
            alt="Core Values"
            class="w-full md:max-w-lg lg:max-w-xl rounded-lg"
          />
        </div>
      </div>

     <div className="text-center justify-center pb-20 bg-black bg-opacity-10">
      <h1 className="text-[35px] font-bold">About Us</h1>
      <p className="text-[20px]">
      As a leading software solutions development company, we are
              renowned for delivering exceptional products and custom app
              development services. Our team comprises top 1% talent in the IT
              industry, comprising highly skilled professionals with over 5+
              years of domain expertise. Our distinct team of designers and
              developers follows industry-leading practices to develop
              innovative solutions that are futuristic and user-friendly. We are
              a fast-growing business that works with a diverse range of
              exciting clients across the globe, spanning various verticals. Our
              dream has always been to provide excellent solutions to our
              clients that can help them reduce costs and save time. Over the
              years, we have evolved into a prominent service provider in the
              software solutions industry, and we take great pride in our
              journey.
      </p>
     </div>
    </>
